...
<div id="banner" class="inner-banner">
    ...
    <video id="videobcg" preload="auto" autoplay="true" loop="loop" muted="muted" volume="0">
        <source src="../theme/assets/images/uiux-design.mp4" type="video/mp4">
		...
		<div class="row pt-45">
			<div class="col-lg-4 col-sm-6" data-aos="fade-up" data-aos-duration="500">
				<div class="work-process-card-three">
                    ...
                    <img src="{{ asset('theme') }}/assets/images/icons/website-app-design.svg" class="brand-logo-one" alt="Website and App Design" style="width:22%;">
				</div>
			</div>
            <div class="col-lg-4 col-sm-6" data-aos="fade-up" data-aos-duration="750">
				<div class="work-process-card-three">
                    ...
                    <img src="{{ asset('theme') }}/assets/images/icons/ux-research.svg" class="brand-logo-one" alt="ux-research" style="width:22%;">
				</div>
			</div>
            <div class="col-lg-4 col-sm-6" data-aos="fade-up" data-aos-duration="1000">
				<div class="work-process-card-three">
                    ...
                    <img src="{{ asset('theme') }}/assets/images/icons/prototyping.svg" class="brand-logo-one" alt="prototyping" style="width:22%;">
				</div>
			</div>
		</div>
	</div>
