...
<div class="case-study-area pt-100 pb-70 portfolio-section" id="portfolio">
    <div class="container">
        ...
        <ul class="row portfolio-item list-unstyled">
            ...
            <li class="mix collateral col-xl-4 pd">
                <div class="case-study-item">
            ...
            <li class="mix social-media col-xl-4 pd">
                <div class="case-study-item">
            ...
            <li class="mix collateral col-xl-4 pd">
                <div class="case-study-item">
                    <img src="{{ asset('theme') }}/assets/images/portfolio/logo/logo-10.jpg" alt="Images">
                    <div class="portfolio-overlay">
                        <div class="overlay-content">
                            <p class="category">KitaraCloud Techlabs</p>
                            <a data-fancybox="item" title="click to zoom-in" href="{{ asset('theme') }}/assets/images/portfolio/logo/logo-10.jpg">
                                <div class="magnify-icon">
                                    <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                                </div>
                            </a>
            ...
            <li class="mix collateral col-xl-4 pd">
                <div class="case-study-item">
                    <img src="{{ asset('theme') }}/assets/images/portfolio/logo/logo-1.jpg" alt="Images">
                    <div class="portfolio-overlay">
                        <div class="overlay-content">
                            <p class="category">24K Springs</p>
                            <a data-fancybox="item" title="click to zoom-in" href="{{ asset('theme') }}/assets/images/portfolio/logo/logo-1.jpg">
                                <div class="magnify-icon">
                                    <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                                </div>
                            </a>
            ...
            <li class="mix collateral col-xl-4 pd">
                <div class="case-study-item">
                    <img src="{{ asset('theme') }}/assets/images/portfolio/logo/logo-2.jpg" alt="Images">
                    <div class="portfolio-overlay">
                        <div class="overlay-content">
                            <p class="category">4Square Solutions</p>
                            <a data-fancybox="item" title="click to zoom-in" href="{{ asset('theme') }}/assets/images/portfolio/logo/logo-2.jpg">
                                <div class="magnify-icon">
                                    <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                                </div>
                            </a>
            ...
            <li class="mix collateral col-xl-4 pd">
                <div class="case-study-item">
                    <img src="{{ asset('theme') }}/assets/images/portfolio/logo/logo-3.jpg" alt="Images">
                    <div class="portfolio-overlay">
                        <div class="overlay-content">
                            <p class="category">Aaryan Designs</p>
                            <a data-fancybox="item" title="click to zoom-in" href="{{ asset('theme') }}/assets/images/portfolio/logo/logo-3.jpg">
                                <div class="magnify-icon">
                                    <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                                </div>
                            </a>
            ...
            <li class="mix collateral col-xl-4 pd">
                <div class="case-study-item">
                    <img src="{{ asset('theme') }}/assets/images/portfolio/logo/logo-4.jpg" alt="Images">
                    <div class="portfolio-overlay">
                        <div class="overlay-content">
                            <p class="category">Sanghvi Eye Care</p>
                            <a data-fancybox="item" title="click to zoom-in" href="{{ asset('theme') }}/assets/images/portfolio/logo/logo-4.jpg">
                                <div class="magnify-icon">
                                    <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                                </div>
                            </a>
            ...
            <li class="mix collateral col-xl-4 pd">
                <div class="case-study-item">
                    <img src="{{ asset('theme') }}/assets/images/portfolio/logo/logo-5.jpg" alt="Images">
                    <div class="portfolio-overlay">
                        <div class="overlay-content">
                            <p class="category">Vasudev & Sons</p>
                            <a data-fancybox="item" title="click to zoom-in" href="{{ asset('theme') }}/assets/images/portfolio/logo/logo-5.jpg">
                                <div class="magnify-icon">
                                    <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                                </div>
                            </a>
            ...
            <li class="mix collateral col-xl-4 pd">
                <div class="case-study-item">
                    <img src="{{ asset('theme') }}/assets/images/portfolio/logo/logo-6.jpg" alt="Images">
                    <div class="portfolio-overlay">
                        <div class="overlay-content">
                            <p class="category">Burger Bhai</p>
                            <a data-fancybox="item" title="click to zoom-in" href="{{ asset('theme') }}/assets/images/portfolio/logo/logo-6.jpg">
                                <div class="magnify-icon">
                                    <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                                </div>
                            </a>
            ...
            <li class="mix collateral col-xl-4 pd">
                <div class="case-study-item">
                    <img src="{{ asset('theme') }}/assets/images/portfolio/logo/logo-7.jpg" alt="Images">
                    <div class="portfolio-overlay">
                        <div class="overlay-content">
                            <p class="category">Goddy Homes</p>
                            <a data-fancybox="item" title="click to zoom-in" href="{{ asset('theme') }}/assets/images/portfolio/logo/logo-7.jpg">
                                <div class="magnify-icon">
                                    <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                                </div>
                            </a>
            ...
            <li class="mix collateral col-xl-4 pd">
                <div class="case-study-item">
                    <img src="{{ asset('theme') }}/assets/images/portfolio/logo/logo-8.jpg" alt="Images">
                    <div class="portfolio-overlay">
                        <div class="overlay-content">
                            <p class="category">Avanti Estates</p>
                            <a data-fancybox="item" title="click to zoom-in" href="{{ asset('theme') }}/assets/images/portfolio/logo/logo-8.jpg">
                                <div class="magnify-icon">
                                    <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                                </div>
                            </a>
            ...
            <li class="mix collateral col-xl-4 pd">
                <div class="case-study-item">
                    <img src="{{ asset('theme') }}/assets/images/portfolio/logo/logo-9.jpg" alt="Images">
                    <div class="portfolio-overlay">
                        <div class="overlay-content">
                            <p class="category">Bagdot</p>
                            <a data-fancybox="item" title="click to zoom-in" href="{{ asset('theme') }}/assets/images/portfolio/logo/logo-9.jpg">
                                <div class="magnify-icon">
                                    <p><span><i class="fa fa-search" aria-hidden="true"></i></span></p>
                                </div>
                            </a>
