    ...
    <div class="breadcrumb-with-buttons mb-24 flex-between flex-wrap gap-8">
        ...
        <div class="flex-align gap-8 flex-wrap">
            <div class="flex-align text-gray-500 text-13 border-gray-100 focus-border-main-600">
                <a href="{{ route('industries.create') }}" class="btn btn-primary"><i class="fa fa-plus"></i> Add Blog</a>
            </div>
        </div>
            ...
            <table id="studentTable" class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><span class="h6 mb-0 fw-medium text-gray-300">{{ Str::limit(strip_tags($industries->industries_name), 50) }}</span></td>
                        <td><span class="h6 mb-0 fw-medium text-gray-300">{{ $industries->author_name }}</span></td>
                        <td><span class="h6 mb-0 fw-medium text-gray-300">{{ Str::limit($industries->publish_date, 30) }}</span></td>
                        <td><span class="h6 mb-0 fw-medium text-gray-300">{{ Str::limit($industries->status, 50) }}</span></td>
                        <td>
