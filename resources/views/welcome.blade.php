...
<head>
	...
	<title>Digital Marketing Services | Account Management Services</title>
	<meta name="keywords" content="IT Services, Account Management services, Digital marketing services, Website Design company, Website design services, End to end sales, outsourcing, Affordable digital marketing services, Website marketing services, SEO service agency, Social media marketing, SEO company for business">
			...
			<div class="row align-items-center justify-content-center">
				...
				<div class="col-lg-7">
					<div class="row">
                        ...
                        <div class="col-lg-3 col-sm-3">
							<div class="work-process-card">
                                <img src="{{ asset('theme') }}/assets/technologies/angular_js.png" class="" alt="Images">
							</div>
						</div>
                        <div class="col-lg-3 col-sm-3">
							<div class="work-process-card">
                                <img src="{{ asset('theme') }}/assets/technologies/.net.png" class="w-100" alt="Images">
							</div>
						</div>
                        <div class="col-lg-3 col-sm-3">
							<div class="work-process-card">
                                <img src="{{ asset('theme') }}/assets/technologies/java.png" class="w-100" alt="Images">
							</div>
						</div>
                        <div class="col-lg-3 col-sm-3">
							<div class="work-process-card">
                                <img src="{{ asset('theme') }}/assets/technologies/laravel.png" class="w-100" alt="Images">
							</div>
						</div>
                        <div class="col-lg-3 col-sm-3">
							<div class="work-process-card">
                                <img src="{{ asset('theme') }}/assets/technologies/node_js.png" class="w-100" alt="Images">
							</div>
						</div>
                        <div class="col-lg-3 col-sm-3">
							<div class="work-process-card">
                                <img src="{{ asset('theme') }}/assets/technologies/vue_js.png" class="w-100" alt="Images">
							</div>
						</div>
                        <div class="col-lg-3 col-sm-3">
							<div class="work-process-card">
                                <img src="{{ asset('theme') }}/assets/technologies/cpp.png" class="w-100" alt="Images">
							</div>
						</div>
                        <div class="col-lg-3 col-sm-3">
							<div class="work-process-card">
                                <img src="{{ asset('theme') }}/assets/technologies/python.png" class="w-100" alt="Images">
							</div>
						</div>
                        <div class="col-lg-3 col-sm-3">
							<div class="work-process-card">
                                <img src="{{ asset('theme') }}/assets/technologies/next_js.png" class="w-100" alt="Images">
							</div>
						</div>
                        <div class="col-lg-3 col-sm-3">
							<div class="work-process-card">
                                <img src="{{ asset('theme') }}/assets/technologies/flutter.png" class="w-100" alt="Images">
							</div>
						</div>
                        <div class="col-lg-3 col-sm-3">
							<div class="work-process-card">
                                <img src="{{ asset('theme') }}/assets/technologies/ror.png" class="w-100" alt="Images">
							</div>
						</div>
					</div>
				</div>
